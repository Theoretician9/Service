...
2. ПРОШЛЫЙ ОПЫТ — как УСИЛИТЕЛЬ, а не как отдельная ниша:
   - Если человек работал на ЧПУ но написал "не моё" → НЕ делай нишу "изготовление на ЧПУ"
   - Вместо этого: "боты для ЧПУ-производств" (текущий навык + знание отрасли)
   - Прошлый опыт = знание рынка и болей, а НЕ предложение вернуться к старому
   - ГЛОНАСС-опыт + навык ботов → "автоматизация мониторинга транспорта через ботов"
