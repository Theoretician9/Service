...
NICHE_SELECTION_MSGS = [
    ...
    # social_capital (if bot asks)
    "Знакомые в стройке, контакты поставщиков, пара знакомых бригад. Тесть строительным бизнесом занимается.",
    # extra clarification
    "Да всё верно, давай анализируй",
    # confirmation
    "Готов, запускай",
